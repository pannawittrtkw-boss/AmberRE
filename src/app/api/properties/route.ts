...
export async function POST(req: NextRequest) {
  try {
    ...
    const {
      ...
      address, latitude, longitude, province, district, subdistrict, amenityIds, stationIds,
      ...
      status, category, priority, foreignerAccept, petFriendly, smokingAllowed, note, imageUrls, projectId, nearbyPlaces,
    ...
    const property = await prisma.property.create({
      data: {
        ...
        foreignerAccept: foreignerAccept || "ACCEPT",
        petFriendly: petFriendly || "NOT_ACCEPT",
        smokingAllowed: smokingAllowed || "NOT_ACCEPT",
        note: note || null,
        ownerId: userId,
        ...
        nearbyPlaces: nearbyPlaces?.length ? JSON.stringify(nearbyPlaces) : null,
